...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/image-blog/flexsearch.min.js');loadScript('/image-blog/en.search-data.min.1e0bca412d5bd86ebf7a17d80b38bdf30109857d458e669139b99a299ac1ccc4.js',function(){input.required=false;search();});}
