...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/image-blog/flexsearch.min.js');loadScript('/image-blog/en.search-data.min.3fcb0df6eeede918d8fdc4857f221af951256a04a904ec477e42e7608373fc30.js',function(){input.required=false;search();});}
