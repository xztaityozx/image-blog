...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/image-blog/flexsearch.min.js');loadScript('/image-blog/en.search-data.min.0accec8b147186a58cb962cd484bf494015ef8c59620eca98c7adee11cbe25f9.js',function(){input.required=false;search();});}
