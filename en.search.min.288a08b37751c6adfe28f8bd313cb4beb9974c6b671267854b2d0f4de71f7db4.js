...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/image-blog/flexsearch.min.js');loadScript('/image-blog/en.search-data.min.626043809648c846aba060afcb166c4464d46e7deee7fcff1c6ddbd47c98a7d0.js',function(){input.required=false;search();});}
