...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/image-blog/flexsearch.min.js');loadScript('/image-blog/en.search-data.min.2fd9afe509f72d6be2aa929aff568753326ca0d4fcd6d4f14a48874cb19a4e42.js',function(){input.required=false;search();});}
